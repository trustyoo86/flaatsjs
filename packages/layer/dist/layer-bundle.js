...
var Layer = /** @class */ (function () {
    ...
    Layer.prototype.initialize = function () {
        ...
        // layer base binding
        var layerBase = this.getLayerBase();
     ...
     */
    Layer.prototype.setBase = function (layerBase, callback) {
     ...
     */
    Layer.prototype.getControlBase = function () {
        // control base
        var controlBase = jquery_1.default('<div class="control-base"></div>')
            .css({
            'width': '100%',
            'height': '100%',
            'position': 'absolute',
     ...
     */
    Layer.prototype.getLayerBase = function () {
        var layerBase = jquery_1.default('<div class="layer-base"></div>')
            .css({
            'position': 'absolute',
            'top': 0,
            'left': 0,
    ...
    Layer.prototype.getOptions = function (opt) {
        if (!opt) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=layer-bundle.js.map